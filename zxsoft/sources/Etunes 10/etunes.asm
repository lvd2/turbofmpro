...
ETunes_load:
		...
		ld	bc,7ffdh
		out	(c),a
		ld	hl,0EC00h			;грузим музыкальный пак 7.
		ld	de,(5CF4h)
		ld	bc,1405h
		call	3d13h
...
ETunes_tabl_music:
		...
		db	16h   				; 20 музыкальное произведение
		dw	0C000h
		...
		db	12h   				; 30 музыкальное произведение
		dw	0EC00h
...
Etunes_end:
		...
		.include  title_6.asm
		.include  title_7.asm
		.savebin "title.bin",Title_table_E10, Title_end - Title_table_E10
